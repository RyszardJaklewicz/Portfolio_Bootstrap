...
foreach ($work_wordpress as $k => $v) {
if($work_wordpress[$k]['show']=="1"){
?>
    ...
    <div class="div_nadrzedny"  style="display:block;">
        <span class="tytul_nazwa_wykonanego_serwisu">
          <div class="div_tytul_nazwa_wykonanego_serwisu">
            <?php  echo "<strong>".$work_wordpress[$k]['tytul']."</strong><br />"; ?>
          </div>
        </span>
		<p></p>
		...
		<?php
       //$work_wordpress[$k]['tytul_opisu'];
       //$work_wordpress[$k]['link_opisu'];
       //$work_wordpress[$k]['opis'];
		print($work_wordpress[$k]['opis']); ?>
        <p></p>
...
<?php
}//END if($work_wordpress[$k]['show']=="1"){
}//END foreach ($work_wordpress as $k => $v) {
?>
