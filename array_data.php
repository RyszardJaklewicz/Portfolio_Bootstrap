...
$menu_portfolio = array(
	'menu_11' => array(
					...
					'link_pozycji_menu'=>'about-me.php',
					),
	'menu_12' => array(
					'show'=>'1',
	...
	'menu_4' => array(
					...
					'link_pozycji_menu'=>'code_example.php',
					),
	'menu_5' => array(
					'show'=>'1',
					'tytul_pozycji_menu'=>'Praca z Wordpress',
					'link_pozycji_menu'=>'work_wordpress.php',
					),
...
$example_data = array(
	...
	'example_data_2' => array(
					'item'=>'1',
					'show'=>'1',
					'div_left_style'=>'height:700px;',
					'nowe_linie_przed_tytulem'=>'',
					'tytul'=>'Title example data 2',
					'opis_w_lewej_kolumnie'=>'
					',
					'tytul_opisu'=>'',
					'opis'=>'
	...
	'example_data_3' => array(
					'item'=>'1',
					'show'=>'1',
					'div_left_style'=>'height:700px;',
					'nowe_linie_przed_tytulem'=>'',
					'tytul'=>'Title example data 3',
					'opis_w_lewej_kolumnie'=>'
					',
					'tytul_opisu'=>'',
					'opis'=>'
...
$work_wordpress = [];
$work_wordpress = array(
	'work_wordpress_1' => array(
					'item'=>'',
					'code_position'=>'leady_fb',
					'show'=>'1',
					'div_left_style'=>'height:600px;',
					'nowe_linie_przed_tytulem'=>'',
					'tytul'=>'Doświadczenia z CMS Wordpress',
					'tytul_opisu'=>'',
					'opis'=>'
					<img src="pliki_serwisu/zdjecia_artykuly/punkt_trojkatny.gif">
					Serwis firmy bazy.danych - bazy.danych.com, stworzony na Wordpress<p></p>
					<a href="https://bazy.danych.com">bazy.danych.com</a><br>
					Zakres prac:<p></p>
					<img src="pliki_serwisu/zdjecia_artykuly/punkt_trojkatny.gif"> instalacja szablonu Advolix,<br>
					<img src="pliki_serwisu/zdjecia_artykuly/punkt_trojkatny.gif"> dostosowanie szablonu Advolix,<br>
					<img src="pliki_serwisu/zdjecia_artykuly/punkt_trojkatny.gif"> wprowadzenie treści,<br>
					<p></p><p></p>
					<img src="pliki_serwisu/zdjecia_artykuly/punkt_trojkatny.gif">
					Serwis firmy cls.pl kalkulator kredytowy stworzony na Wordpress jako samodzielna strona PHP działająca w strukturze Wordpress<p></p>
					<a href="https://cls.pl/kalkulator">cls.pl/kalkulator</a><br>
					Zakres prac:<p></p>
					<img src="pliki_serwisu/zdjecia_artykuly/punkt_trojkatny.gif"> dołączenie samodzielnej strony na skrypty PHP, js, HTML,<br>
					<img src="pliki_serwisu/zdjecia_artykuly/punkt_trojkatny.gif"> dostosowanie graficzne,<br>
					<img src="pliki_serwisu/zdjecia_artykuly/punkt_trojkatny.gif"> prace programistyczne w zakresie funkcjonalności kalkulatora kredytowego,<br>
					<p></p>
					<img src="pliki_serwisu/zdjecia_artykuly/punkt_trojkatny.gif">
					Tworzenie szablonów Wordpress "Od zera"<br>
					<img src="pliki_serwisu/zdjecia_artykuly/punkt_trojkatny.gif">
					Dodawanie do Wordpress dowolnej funkcjonalności w oparciu o kod PHP i bazę danych (np poprzez dołączanie stron do struktury Wordpress)<br>
					<img src="pliki_serwisu/zdjecia_artykuly/punkt_trojkatny.gif">
					Wyciąganie danych z tabel bazy danych Wordpressa<br>
					<img src="pliki_serwisu/zdjecia_artykuly/punkt_trojkatny.gif">
					Inne
					',
					'link_grafiki'=>'',
	...
	'work_wordpress_2' => array(
					'item'=>'',
					'code_position'=>'',
					'show'=>'1',
					'div_left_style'=>'height:500px;',
					'nowe_linie_przed_tytulem'=>'',
					'tytul'=>'Rozbudowa / modyfikacje funkcjonalności Wordpressa',
					'tytul_opisu'=>'',
					'opis'=>'
					<img src="pliki_serwisu/zdjecia_artykuly/punkt_trojkatny.gif"> Tworzenie wtyczek - pluginów do Wordpress,<br>
					<img src="pliki_serwisu/zdjecia_artykuly/punkt_trojkatny.gif"> Tworzenie pojedyńczych stron rozszerzających funkcjonalność Wordpresa
					',
					'link_grafiki'=>'',
					'width_image'=>'',
					'link_punkt_trojkatny'=>'pliki_serwisu/zdjecia_artykuly/punkt_trojkatny.gif',
